...
ActiveRecord::Schema.define(version: 20151112003849) do
  ...
  add_index "shortened_urls", ["submitted_id"], name: "index_shortened_urls_on_submitted_id"
  ...
  add_index "tags", ["topic"], name: "index_tags_on_topic", unique: true
